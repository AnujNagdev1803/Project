...
if(request.getParameter("msg")!=null){%>
   ...
   <script>alert('File Uploaded in Two Clouds..!')</script>
<%}
...
<div id="container">
  ...
  <div id="content" >
      ...
      <p><center><font size="5" color="black">View Files & Split </font></center></p><br/>
    <style>
        th{
            color: #50aac3;
        }
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from clientfile where owner = '"+user+"'");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="client_viewfiles1.jsp?filename=<%=rs.getString(1)%>&owner=<%=rs.getString(2)%>&filedata=<%=rs.getString(3)%>"><font color="#0d637d" size="3">View</font></a> </td>
