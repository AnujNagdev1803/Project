...
<div id="container">
  ...
  <div id="content" >
   ...
   String cloud1data = null;
   String cloud1key = null;
   
   String content = new decryption().decrypt(cloud2data, fkey);
...
//String seconddata = filedata.substring(len,l);
    ...
    ResultSet rs = st.executeQuery("select * from clientupload where fname= '"+fname+"' and cloud = 'cloud1' ");
    if(rs.next())
    {
    cloud1data = rs.getString("filedata");
    cloud1key = rs.getString("fkey");
    }
   
   String cloud1content = new decryption().decrypt(cloud1data, cloud1key);
   ...
   <center>
           ...
           <form name="f" action="client_cloud2modify2.jsp" method="post" >  <center>
<table>
       ...
       <tr>
        ...
        <input type="hidden" name="cloud2data" value="<%=content%>" style="height:30px; width:170px">
         <input type="hidden" name="cloud1data" value="<%=cloud1content%>" style="height:30px; width:170px">
        ...
        <tr>
          ...
          <tr>
              ...
              <th><textarea type="text" name="part2data" value="<%=content%>" style="height:30px; width:170px"><%=content%></textarea>
              </th>
        </tr> 
