...
<div id="container">
  ...
  <div id="content" >
      ...
      <p><center><font size="5" color="black">Download Cloud1 & Cloud2 Data </font></center></p><br/>
    <style>
        th{
            color: #50aac3;
        }
   ...
   String cloud1key = request.getParameter("cloud1key");
   String cloud2key = request.getParameter("cloud2key");
   String part1data = null;
   String part2data = null;
   //Decription
   String cloud1content = null;
   String cloud2content = null;
  

    Connection con=Dbconnection.getConnection();
    Statement st = con.createStatement();
    ResultSet rs = st.executeQuery("select * from clientrequest where filename= '"+filename+"' and id = '"+fileid+"' and part1key = '"+cloud1key+"' and part2key = '"+cloud2key+"' ");
    if(rs.next())
    {
    part1data = rs.getString("part1data");
    part2data = rs.getString("part2data");
    cloud1content = new decryption().decrypt(part1data, cloud1key); 
    cloud2content = new decryption().decrypt(part2data, cloud2key); 
   ...
   <center>
           ...
           <form name="f" action="client_download3.jsp" method="post" >  <center>
<table>
       ...
       <tr>
        ...
        <tr>
         ...
         <tr>
              <th><font color="black" size="4">Cloud1 Data:</th>
              <th><textarea type="text" name="cloud1content" value="<%=cloud1content%>" style="height:30px; width:170px"><%=cloud1content%></textarea>
              </th>
        </tr>        
          ...
          <tr>
              ...
              <th><textarea type="text" name="cloud2content" value="<%=cloud2content%>" style="height:30px; width:170px"><%=cloud2content%></textarea>
              </th>
        </tr> 
	  ...
	  <tr>
              <td>
                    <input type="submit" value="Download"  style="height:30px; width:65px" />
