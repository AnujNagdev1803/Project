...
<div id="container">
  ...
  <div id="nav">
     <ul>
      ...
      <li><a href="ss2_viewfiles.jsp"><span>View Files</span></a></li>
      <li class="active"><a href="ss2_viewrequests.jsp"><span>View Requests</span></a></li>
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from clientrequest where part2status = 'Pending'");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="ss2_viewrequests1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>&user=<%=rs.getString("user")%>&id=<%=rs.getInt(1)%>"><font color="#0d637d" size="3">Response</font></a> </td>
