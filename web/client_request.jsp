...
<div id="container">
  ...
  <div id="nav">
   <ul>
      ...
      <li class="active"><a href="client_request.jsp"><span>Request</span></a></li>
  ...
  <div id="content" >
      ...
      <p><center><font size="5" color="black">View Files & Request </font></center></p><br/>
    <style>
        th{
            color: #50aac3;
        }
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from clientfile");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="client_request1.jsp?filename=<%=rs.getString(1)%>&owner=<%=rs.getString(2)%>"><font color="#0d637d" size="3">Request</font></a> </td>
