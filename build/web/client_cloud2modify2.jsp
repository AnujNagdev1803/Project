...
<div id="container">
 ...
 String cloudname =null;
  ...
  String fname = request.getParameter("fname");
   ...
   x =(abc.exactJaccard(cloud1data, part2data)*100);
   
   System.out.println(x);
   
    y =(abc.exactJaccard(cloud2data, part2data)*100);
...
%>
        ...
        <center>
           ...
           <form name="f" action="client_cloud2modify3.jsp" method="post" >  <center>
<table>
     ...
     <input type="hidden" name="fname" value="<%=fname%>" style="height:30px; width:170px">
        ...
        <tr>
          ...
          <tr>
              ...
              <th><textarea type="text" name="part2data" value="<%=part2data%>" style="height:30px; width:170px"><%=part2data%></textarea>  
              </th>
        </tr> 
