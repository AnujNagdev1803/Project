...
<div id="container">
  ...
  <div id="content" >
       ...
       <p><center><font size="5" color="black">View Cloud2 Files </font></center></p><br/>
    <style>
        th{
            color: #50aac3;
        }
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="ms_cloud2files1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>&filedata=<%=rs.getString("filedata")%>&id=<%=rs.getInt(1)%>"><font color="#0d637d" size="3">View</font></a> </td>
