...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="ss1_viewfiles1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString("owner")%>&filedata=<%=rs.getString("filedata")%>&id=<%=rs.getInt(1)%>"><font color="#0d637d" size="3">View</font></a> </td>
